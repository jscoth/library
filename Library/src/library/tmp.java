...
public class LibWindow extends JFrame {
	...
	public LibWindow() {
		...
		//Show Books Label
		JLabel lblShowBooks = new JLabel("Show Books");
		lblShowBooks.setBounds(12, 5, 150, 30);
		lblShowBooks.setPreferredSize(new Dimension(150, 30));
		panel.setLayout(null);
		panel.add(lblShowBooks);
		
		JRadioButton chckbxShowAllBooks = new JRadioButton("Show All Books");
		chckbxShowAllBooks.setSelected(true);
		chckbxShowAllBooks.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				mainTable.setModel(DBManager.resultSetToTableModel(DBManager.queryData("Books", "Title", "Title", "Author", "Genre")));
			}
		});
		...
		chckbxBookTitleAz.setSelected(true);
		...
		btnCheckOut.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent k) {
				...
				String title = (String) mainTable.getModel().getValueAt(row, 0);
				cart.add(title);
		...
		mainTable.setModel(DBManager.resultSetToTableModel(DBManager.queryData("Books", "Title", "Title", "Author", "Genre", "CheckedOut")));
	...
	private void sortButton(String sortBy) {
		mainTable.setModel(DBManager.resultSetToTableModel(DBManager.queryData("Books", sortBy, "Title","Author","Genre")));
	}
}
